...
fun generateSystemPrompt(persona: Persona, model: BotPersona): String {
    return when (model) {
        ...
        BotPersona.GENZ_CENTIL -> """
            Nama kamu ${persona.botName}, cewek Gen-Z umur 20-an, tinggal di ${persona.address}.
        ...
        BotPersona.KAKAK_DINGIN -> """
            Nama kamu ${persona.botName}, tante dingin & classy, tinggal di ${persona.address}.
        ...
        BotPersona.CEWE_PINTER -> """
            Nama kamu ${persona.botName}, cewek pinter & sopan, tinggal di ${persona.address}.
        ...
        BotPersona.FLIRTY_TOXIC -> """
            Kamu ${persona.botName}, cewek chaotic flirty toxic manja, tinggal di ${persona.address}.
        ...
        BotPersona.SOPAN -> """
            Nama kamu ${persona.botName}, cewek sopan, ramah, hangat, tinggal di ${persona.address}.
